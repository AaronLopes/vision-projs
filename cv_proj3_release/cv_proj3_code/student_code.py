...
class SimpleNet(nn.Module):
    """Simple Network with at least 2 conv2d layers and two linear layers."""
    ...
    """
        ...
        self.cnn_layers = nn.Sequential(
            nn.Conv2d(
                in_channels=1, out_channels=10, kernel_size=5, stride=1, padding=0
            ),
        ...
        self.fc_layers = nn.Sequential(
            nn.Linear(54080, 500), nn.Linear(500, 100), nn.Linear(100, 15)
        )
...
def compute_loss(
  ...
  """
    ...
    loss = loss(model_output, target_labels)
    if is_normalize:
...
class MyAlexNet(nn.Module):
    ...
    """
        ...
        self.fc_layers[6] = nn.Linear(4096, 15)
        self.loss_criterion = nn.CrossEntropyLoss(reduction="sum")
...
# TODO EC2.2
def quantize_model(
    float_model: MyAlexNet, train_loader: ImageLoader
) -> MyAlexNetQuantized:
    """
